...
class DefaultPaths:
    ...
    DISSOCIATED = "/media/rokny/DATA2/Sally/Nicheformer/nicheformer/data/spatialcorpus-110M/dissociated"
    SPATIAL = "/media/rokny/DATA2/Sally/Nicheformer/nicheformer/data/spatialcorpus-110M/spatial"
